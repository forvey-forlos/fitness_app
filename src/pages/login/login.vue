...
@media (max-width:899px){
  page{background:var(--bg-a)}.page{position:relative;box-sizing:border-box;min-height:100vh;display:flex;align-items:center;justify-content:center;overflow:auto;padding:calc(var(--status-bar-height) + 86rpx) 28rpx 38rpx;background:radial-gradient(circle at 50% 46%,var(--bg-b),var(--bg-a) 72%)}
  .hero{position:fixed;inset:0;height:auto;background:transparent;pointer-events:none}.brand{position:fixed;left:30rpx;top:calc(var(--status-bar-height) + 22rpx);color:rgba(255,255,255,.78);font-size:20rpx}.brand-mark{width:36rpx;height:36rpx}.figure{display:none}
  .panel{z-index:4;box-sizing:border-box;width:100%;max-width:690rpx;min-height:0;margin:auto;padding:42rpx 36rpx 34rpx;border:1rpx solid rgba(255,255,255,.64);border-radius:38rpx;background:rgba(255,255,255,.92);box-shadow:0 34rpx 90rpx rgba(0,0,0,.3),0 0 65rpx rgba(var(--glow-rgb),.23),inset 0 1rpx 0 #fff;backdrop-filter:blur(26px)}
  .title{font-size:48rpx}.subtitle{margin:10rpx 0 31rpx;font-size:23rpx}.form-item{margin-bottom:21rpx}.label{font-size:21rpx}.input-box{height:88rpx;padding:0 23rpx;border-width:2rpx;border-radius:24rpx}.input{font-size:25rpx}.input-box.focused{border-color:var(--accent);box-shadow:0 0 0 6rpx rgba(var(--glow-rgb),.1)}.checkbox.checked{border-color:var(--accent);background:var(--accent)}.strength-bar.active{background:var(--accent)}.forgot,.register,.agreement-link,.shield{color:var(--accent)}.login-button{height:88rpx;margin-top:24rpx;border-radius:25rpx;background:linear-gradient(100deg,var(--accent),var(--accent-2));box-shadow:0 18rpx 36rpx rgba(var(--glow-rgb),.28)}
  .theme-hitarea{display:block;position:fixed;inset:0;z-index:2}.music-bg{display:block;position:fixed;inset:0;z-index:1;overflow:hidden;pointer-events:none}.theme-wave{display:block;position:fixed;z-index:2;inset:0;background:radial-gradient(circle at 50% 50%,var(--next-b),var(--next-a) 70%);clip-path:circle(0 at 50% 50%);will-change:clip-path;animation:mobileThemeExpand .82s cubic-bezier(.3,.7,.15,1) forwards;pointer-events:none}@keyframes mobileThemeExpand{to{clip-path:circle(90vmax at 50% 50%)}}
  .dot-halo{position:absolute;left:50%;top:48%;width:850rpx;height:850rpx;transform:translate(-50%,-50%);opacity:.5;background-image:radial-gradient(circle,rgba(var(--glow-rgb),.7) 2rpx,transparent 3rpx);background-size:25rpx 25rpx;mask-image:radial-gradient(circle,transparent 0 30%,#000 47%,transparent 73%);animation:mobileHalo 3.8s ease-in-out infinite}@keyframes mobileHalo{50%{opacity:.8;transform:translate(-50%,-50%) scale(1.06)}}
  .sound-ring{position:absolute;left:50%;top:48%;border:2rpx solid rgba(var(--glow-rgb),.3);border-radius:50%;transform:translate(-50%,-50%);animation:mobileRing 3s ease-out infinite}.ring-one{width:620rpx;height:620rpx}.ring-two{width:760rpx;height:760rpx;animation-delay:-1s}.ring-three{width:900rpx;height:900rpx;animation-delay:-2s}@keyframes mobileRing{0%{opacity:.1;transform:translate(-50%,-50%) scale(.9)}55%{opacity:.5}100%{opacity:0;transform:translate(-50%,-50%) scale(1.12)}}
  .scan-wave{position:absolute;left:-15%;width:130%;height:200rpx;border-top:2rpx solid rgba(var(--glow-rgb),.42);border-radius:50%;filter:drop-shadow(0 0 12rpx rgba(var(--glow-rgb),.7));animation:mobileWave 5s ease-in-out infinite}.wave-one{top:20%;transform:rotate(-7deg)}.wave-two{bottom:7%;transform:rotate(8deg);animation-delay:-2.4s}@keyframes mobileWave{0%,100%{opacity:.18;scale:1 .75}50%{opacity:.7;scale:1 1.15}}
  .spectrum{position:absolute;left:3%;right:3%;height:130rpx;display:flex;align-items:flex-end;justify-content:space-between;gap:5rpx;opacity:.55}.spectrum-top{top:5%;transform:rotate(180deg)}.spectrum-bottom{bottom:0}.frequency{flex:1;max-width:12rpx;height:var(--height);border-radius:8rpx;background:linear-gradient(to top,transparent,rgba(var(--glow-rgb),.35),var(--accent-2));transform-origin:bottom;animation:mobileFrequency var(--duration) ease-in-out var(--delay) infinite alternate}@keyframes mobileFrequency{from{transform:scaleY(.18);opacity:.34}to{transform:scaleY(1);opacity:.92}}
  .music-caption{position:fixed;right:28rpx;top:calc(var(--status-bar-height) + 31rpx);display:flex;align-items:center;gap:8rpx;color:rgba(255,255,255,.52);font-size:15rpx;letter-spacing:2rpx}.caption-dot{width:9rpx;height:9rpx;border-radius:50%;background:var(--accent-2);box-shadow:0 0 15rpx var(--accent-2);animation:mobileBeat .75s ease-in-out infinite alternate}@keyframes mobileBeat{to{transform:scale(1.8);opacity:.45}}
}
</style>
